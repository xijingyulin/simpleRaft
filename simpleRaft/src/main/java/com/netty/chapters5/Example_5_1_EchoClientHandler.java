...
public class Example_5_1_EchoClientHandler extends ChannelHandlerAdapter {

	private int counter;
	static final String ECHO_REQ = "Hi, WSK. WELCOME TO NETTY.$_";

	public Example_5_1_EchoClientHandler() {
	}
